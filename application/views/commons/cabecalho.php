...
<html lang="pt_BR">
    <head>
        ...
        <meta name="description" content="CRUD com CodeIgniter">
        <meta name="author" content="ezoom">
        <link rel="icon" href="<?=base_url('assets/images/ezoom-2.png')?>">
...
<?php $this->load->view('commons/cabecalho-padrao'); ?>
